    ...
    <div>
      <div className="max-w-container mx-auto py-18">
        ...
        <div className=" mx-auto  w-[330px] md:w-[480px] py-5 relative ">
          <input
            className="py-5  px-0 md:px-6  w-[330px]  md:w-[480px] rounded-lg outline-none"
            placeholder="Your business email"
          />

          <div className=" py-2 md:py-3  px-4 md:px-10 border-2 bg-comon rounded-md  w-[130px] md:w-[180px] absolute  top-8 md:top-6 right-1  ">
